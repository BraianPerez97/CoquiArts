...
export default function NestedList() {
  ...
  return (
    <List
      sx={{ left:"26%", width: '70%', maxWidth: 360, bgcolor: 'background.transparent', border: 'solid 3px var(--black)',borderRadius: '10px',
    ...
    >
      ...
      <ListItemButton onClick={() => handleClick(categories.name)}>
        <ListItemText primary="--" /><ExpandMoreIcon></ExpandMoreIcon>
      </ListItemButton>
