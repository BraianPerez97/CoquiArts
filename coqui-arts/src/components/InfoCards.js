...
const categories = [
  ...
  return (
    ...
    <section className=" container3">
      ...
      <div className="form">
            <h1 className="card-title info-title"> What makes a good <span>CoquiArts</span> profile?</h1>
            <span className="info-sub">First impressions matter. Create a profile that will stand out</span>
    
           <div className="cat">
        {categories.map((category) => (
          <div className=" info-item" onClick={()=> categorySelected(category.name)}>
            <p id="cat-img">
